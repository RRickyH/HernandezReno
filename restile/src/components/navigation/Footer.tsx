        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <NavLink to="/" className="inline-block mb-4">
              <div className="flex items-center gap-3">
                <img src="HR_logo.svg" alt="Hernández Renovations Logo" className="h-12 w-auto"/>
                <span className="text-xl font-bold text-white">Hernández Renovations</span>
              </div>
            </NavLink>
            <p className="text-gray-300 mb-4 leading-relaxed">
              Bringing over a decade of expertise to home renovations across the Niagara region.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <NavLink to="/gallery" className="text-gray-300 hover:text-white transition-colors duration-200 flex items-center">
                  Kitchen Renovations
                </NavLink>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <NavLink to="/gallery" className="text-gray-300 hover:text-white transition-colors duration-200">
                  Project Gallery
                </NavLink>
              </li>
              <li>
          ...
          <div>
            ...
            <div className="space-y-3 mb-6">
              ...
              <ul className="flex items-center gap-3">
                  <li><a
                      href="https://www.facebook.com/profile.php?id=100063469453573&sk=about"
                  ...
                  <li><a
                      href="https://www.instagram.com/finishcarpentryniagara/"
                      className="text-gray-300 hover:text-white transition-colors duration-200"
